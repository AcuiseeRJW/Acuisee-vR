...
//04.08.2019    rjw 6.46 intercept and discard CR(13) or LF(10) in bt and usb read
//04.09.2019    rjw 6.47 do NOT process the character if it is a CR or LF and removed bt no send - now both comm paths the same
//06.26.2019    RJW 6.48 ADDED BACK IN FULL COMM SET SENT TO BT . . . so debug app will see all events
// ----------------------------------------------------------------------------------------------------
